namespace :db do
  ...
  task user_invoices: [:environment] do
    UserInvoice.create!(
      user_id: 1, invoice_id: 1, status: "init")
    UserInvoice.create!(
    ...
    UserInvoice.create!(
      user_id: 7, invoice_id: 7, status: "init")
    UserInvoice.create!(
    ...
    UserInvoice.create!(
      user_id: 1, invoice_id: 11, status: "finished")
    UserInvoice.create!(
      user_id: 2, invoice_id: 12, status: "cancel")
    UserInvoice.create!(
      user_id: 3, invoice_id: 13, status: "init")
    UserInvoice.create!(
    ...
    UserInvoice.create!(
      user_id: 1, invoice_id: 21, status: "shipping")
    UserInvoice.create!(
    ...
    UserInvoice.create!(
      ...
      UserInvoice.create!(
      user_id: 1, invoice_id: 31, status: "init")
    UserInvoice.create!(
    ...
    UserInvoice.create!(
      user_id: 7, invoice_id: 37, status: "init")
    UserInvoice.create!(
    ...
    UserInvoice.create!(
      ...
      UserInvoice.create!(
      user_id: 1, invoice_id: 41, status: "finished")
    UserInvoice.create!(
      user_id: 2, invoice_id: 42, status: "cancel")
    UserInvoice.create!(
      user_id: 3, invoice_id: 43, status: "init")
    UserInvoice.create!(
